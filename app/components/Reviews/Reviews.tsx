      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-5 md:px-12 lg:px-20 mb-12 sm:mb-16 text-center">
        <div className="flex flex-col items-center">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight text-white mb-4">
            Loved By <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-500">100+ Students</span>
          </h2>
          <p className="text-gray-400 text-sm sm:text-base lg:text-lg max-w-xl mx-auto">
            Don't just take our word for it. Here is what actual students have to say about their learning experience.
          </p>
        </div>
      </div>
