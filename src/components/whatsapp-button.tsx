...
export default function WhatsappButton() {
  return (
    ...
    >
      ...
      <span className="max-w-0 overflow-hidden whitespace-nowrap text-xs font-black tracking-wider uppercase transition-all duration-500 ease-out group-hover:max-w-[100px] group-hover:pr-1 select-none font-mono">
        Chat With Us
      </span>
